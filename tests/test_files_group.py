...
from downloaderx.files_group import FileDownloadError, FilesGroup
from downloaderx.invoker import download
from downloaderx.type import RetryError, Task
...
class TestFilesGroup(unittest.TestCase):
    ...
    def test_download_404_and_dispose(self):
        ...
        tasks: list[tuple[str, str]] = [
            (f"/images/{file}", str(temp_path / file)) for file in files
        ]
